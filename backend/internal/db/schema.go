...
func AllSchemas() []CollectionSchema {
	return []CollectionSchema{
		...
		forecastDatasetSchema(),
		forecastInputRowsSchema(),
		forecastJobsSchema(),
		forecastRunsSchema(),
		forecastPointsSchema(),
		forecastMetricsSchema(),
		forecastPoliciesSchema(),
		guestPlansSchema(),
