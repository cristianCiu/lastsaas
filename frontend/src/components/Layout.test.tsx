...
const mocks = vi.hoisted(() => ({ isRootTenant: false }));
...
vi.mock('../contexts/TenantBrandingContext', () => ({ useTenantBranding: () => ({ primaryLogoUrl: 'blob:primary', compactLogoUrl: 'blob:compact' }) }));
...
describe('Layout tenant logos', () => {
  beforeEach(() => { mocks.isRootTenant = false; });
